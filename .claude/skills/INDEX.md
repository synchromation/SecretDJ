...
| [swiftui-views](swiftui-views/SKILL.md) | Writing SwiftUI views | View composition and extraction, model access from views (`let model` / `@State` / `@Bindable`), current-API choices, previews, accessibility |
